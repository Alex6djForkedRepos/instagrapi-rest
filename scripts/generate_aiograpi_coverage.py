...
COVERED_BY_REST_EXACT_METHODS = {
    ...
    "notification_announcements": "covered by generic `PATCH /notifications/settings` with `content_type=announcements`",
    "notification_comment_likes": "covered by generic `PATCH /notifications/settings` with `content_type=comment_likes`",
    "notification_comments": "covered by generic `PATCH /notifications/settings` with `content_type=comments`",
    "notification_connection": "covered by generic `PATCH /notifications/settings` with `content_type=connection_notification`",
    "notification_direct_group_requests": "covered by generic `PATCH /notifications/settings` with `content_type=direct_group_requests`",
    "notification_direct_share_activity": "covered by generic `PATCH /notifications/settings` with `content_type=direct_share_activity`",
    "notification_felix_upload_result": "covered by generic `PATCH /notifications/settings` with `content_type=felix_upload_result`",
    "notification_first_post": "covered by generic `PATCH /notifications/settings` with `content_type=first_post`",
    "notification_follow_request_accepted": "covered by generic `PATCH /notifications/settings` with `content_type=follow_request_accepted`",
    "notification_fundraiser_creator": "covered by generic `PATCH /notifications/settings` with `content_type=fundraiser_creator`",
    "notification_fundraiser_supporter": "covered by generic `PATCH /notifications/settings` with `content_type=fundraiser_supporter`",
    "notification_like_and_comment_on_photo_user_tagged": "covered by generic `PATCH /notifications/settings` with `content_type=like_and_comment_on_photo_user_tagged`",
    "notification_likes": "covered by generic `PATCH /notifications/settings` with `content_type=likes`",
    "notification_live_broadcast": "covered by generic `PATCH /notifications/settings` with `content_type=live_broadcast`",
    "notification_login": "covered by generic `PATCH /notifications/settings` with `content_type=login_notification`",
    "notification_new_follower": "covered by generic `PATCH /notifications/settings` with `content_type=new_follower`",
    "notification_pending_direct_share": "covered by generic `PATCH /notifications/settings` with `content_type=pending_direct_share`",
    "notification_reminders": "covered by generic `PATCH /notifications/settings` with `content_type=notification_reminders`",
    "notification_report_updated": "covered by generic `PATCH /notifications/settings` with `content_type=report_updated`",
    "notification_rooms": "covered by generic `PATCH /notifications/settings` with `content_type=rooms`",
    "notification_tagged_in_bio": "covered by generic `PATCH /notifications/settings` with `content_type=tagged_in_bio`",
    "notification_user_tagged": "covered by generic `PATCH /notifications/settings` with `content_type=user_tagged`",
    "notification_video_call": "covered by generic `PATCH /notifications/settings` with `content_type=video_call`",
